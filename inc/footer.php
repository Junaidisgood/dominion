                ...
                <div class="row">
                    <div class="col-lg-4 col-6">
                        <div class="widget contact-info-widget">
                            ...
                            <ul>
                                <li>
                                    <h5>Address:</h5>
                                    <p>Gelsenkirchener Strasse 6, 40472 Düsseldorf, Germany.</p>
                                </li>
                                <li>
                                    <h5>Call Now:</h5>
                                    <p><a href="callto:+2568964793682">+49 2115861076</a></p>
                                    <p><a href="callto:+8696732986346">+49 2115861942</a></p>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-6">
                        <div class="widget subscribe-widget">
                            ...
                            <form action="scripts/subscribe.php" method="post" name="subscribe-form" class="subscribe-form">
                               <p>Subscribe to our Newsletter</p>

                                <div class="input-group mb-3">
                                    <input type="email" class="form-control" placeholder="Your Email" name="email-sub" required="">
                                    <div class="input-group-append">
                                        <button type="submit" class="subsmit-sub input-group-text text-light bg-warning border-0"><i class="fa fa-envelope"></i></button>
                                    </div>
                                </div>
                            </form>
               ...
               <div class="container">
                    <div class="copyright-inner align-items-center">
                        <div class="copyright-wrap order-2 order-md-1">
                            ...
                            <!-- Scroll Top Button -->
                            <button class="scroll-top scroll-to-target wow fadeInUp" data-wow-duration="3s" data-target="html"><i class="fas fa-angle-double-up"></i></button>
                            <!-- footer menu -->
                        </div>
                    </div>
                </div>
